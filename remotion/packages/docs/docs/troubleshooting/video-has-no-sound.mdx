...
Make sure your Remotion composition includes an audio source. You can add audio using [`<Audio>`](/docs/using-audio), or extract audio from a video using [`<Html5Video>`](/docs/html5-video) or [`<OffthreadVideo>`](/docs/offthreadvideo).
